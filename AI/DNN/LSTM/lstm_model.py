...
from keras.layers import Input, Dropout, BatchNormalization, Activation, Embedding
from keras.layers import Multiply, Lambda, RepeatVector, Permute, merge
...
def build_lstm_model(ATTENTION=False):
    ...
    #lstm
    activations = LSTM(LSTM_UNITS, return_sequences=True)(bn)
    
    if ATTENTION:
        #attention
        attention = my_attention_vec(activations, LSTM_UNITS)
        #merge
